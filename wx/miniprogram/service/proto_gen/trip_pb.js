...
export const coolcar = $root.coolcar = (() => {
    ...
    coolcar.Location = (function() {
         ...
         * @memberof coolcar
         * @interface ILocation
         * @property {number|null} [lagitude] Location lagitude
        ...
        /**
         * Location lagitude.
         * @member {number} lagitude
         * @memberof coolcar.Location
         * @instance
         */
        Location.prototype.lagitude = 0;
        ...
        Location.fromObject = function fromObject(object) {
            ...
            if (object.lagitude != null)
                message.lagitude = Number(object.lagitude);
        ...
        Location.toObject = function toObject(message, options) {
            ...
            if (message.lagitude != null && message.hasOwnProperty("lagitude"))
                object.lagitude = options.json && !isFinite(message.lagitude) ? String(message.lagitude) : message.lagitude;
     ...
     * @enum {number}
     * @property {number} IS_NOT_SPECITED=0 IS_NOT_SPECITED value
    ...
    coolcar.TripStatus = (function() {
        ...
        values[valuesById[0] = "IS_NOT_SPECITED"] = 0;
    ...
    coolcar.Trip = (function() {
        ...
        Trip.toObject = function toObject(message, options) {
            ...
            if (options.defaults) {
                ...
                object.endPos = null;
                object.status = options.enums === String ? "IS_NOT_SPECITED" : 0;
            }
