...
type TripServiceClient interface {
	...
	GetTrips(ctx context.Context, in *GetTripsRequest, opts ...grpc.CallOption) (*GetTripsReponse, error)
...
func (c *tripServiceClient) GetTrips(ctx context.Context, in *GetTripsRequest, opts ...grpc.CallOption) (*GetTripsReponse, error) {
	out := new(GetTripsReponse)
...
type TripServiceServer interface {
	...
	GetTrips(context.Context, *GetTripsRequest) (*GetTripsReponse, error)
...
func (UnimplementedTripServiceServer) GetTrips(context.Context, *GetTripsRequest) (*GetTripsReponse, error) {
...
const (
	ProfileService_GetProfile_FullMethodName    = "/rental.v1.ProfileService/GetProfile"
	ProfileService_SubmitProfile_FullMethodName = "/rental.v1.ProfileService/SubmitProfile"
	ProfileService_ClearProfile_FullMethodName  = "/rental.v1.ProfileService/ClearProfile"
)
...
func (c *profileServiceClient) SubmitProfile(ctx context.Context, in *Identity, opts ...grpc.CallOption) (*Profile, error) {
	out := new(Profile)
	err := c.cc.Invoke(ctx, ProfileService_SubmitProfile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *profileServiceClient) ClearProfile(ctx context.Context, in *ClearProfileRequest, opts ...grpc.CallOption) (*Profile, error) {
	out := new(Profile)
	err := c.cc.Invoke(ctx, ProfileService_ClearProfile_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _ProfileService_ClearProfile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ProfileService_ClearProfile_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
